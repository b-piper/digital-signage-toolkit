...
class RiseVisionTab(BaseTab):
    """Tab for Rise Vision Player operations — clear cache, restart, reboot."""
    ...
    def setup_ui(self):
        ...
        # Info
        info_label = QLabel(
            "💡 Tip: Clearing the cache forces Rise Vision to re-download content. "
            "Use this if displays are showing stale or incorrect content."
        )
