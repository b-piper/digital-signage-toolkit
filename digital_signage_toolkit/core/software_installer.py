...
from ..utils.file_utils import download_with_retry, verify_checksum
...
class SoftwareInstaller:
    ...
    def fix_rise_permissions(self, player_dir: str = "~/rvplayer",
        ...
        # Find chrome-sandbox
        for root, _dirs, files in os.walk(player_path):
        ...
        for cache_dir in cache_dirs:
            if cache_dir.exists():
                try:
                    ...
                    if free_space is not None and free_space < (dir_size * 1.1):
                        if log_callback:
