...
from ..core.timeshift_manager import TimeshiftManager
...
from .tabs import AlertsTab
from .transitions import FadeStackedWidget
from .widgets import LogConsole, StatusWidget
...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self._add_nav_item("Fleet Dashboard", "fa5s.network-wired", page_index)
        page_index += 1
        self._add_nav_item("Network", "fa5s.wifi", page_index)
        page_index += 1
    ...
    def _get_page_index(self, tab_name):
        ...
        tab_order = [
            ...
            "fleet_dashboard", "network", "watchdog", "rise_vision", "scheduler", "alerts", "config",
            "monitoring", "logs",
    ...
    def _create_tabs(self):
        ...
        self.fleet_dashboard_tab = FleetDashboardTab(self)
        ...
        self.page_stack.addWidget(self.fleet_dashboard_tab)
        self.page_stack.addWidget(self.network_tab)
    ...
    def show_about_dialog(self):
        ...
        from .dialogs import ModernAboutDialog
